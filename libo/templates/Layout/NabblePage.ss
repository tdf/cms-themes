...
<div class="typography">
		...
		$Content
<a id="nabblelink"
href="http://nabble.documentfoundation.org/Users-f1639498.html">Users</a>
<script>
{
	...
	if (window.nabble_id && link != null) {
		...
		e.src = 'http://n3.nabble.com/embed/JsEmbed.jtp?id=' + window.nabble_id + '&node=1639498&url=' + encodeURIComponent(location.href);
